...
The email verification service is configured for Brevo SMTP and sends the FYP-UKM R Mall Demo verification email template. Fill in all three `BREVO_*` values on the VM before testing registration or forgot-password email codes.
