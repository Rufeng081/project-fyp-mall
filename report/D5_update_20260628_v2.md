...
Apache JMeter is a suitable tool for this project because it can generate HTTP requests, parameterise thread counts, apply assertions, and produce response-time, throughput, and error-rate data. In R Mall, JMeter plans are created for eight scenarios:
