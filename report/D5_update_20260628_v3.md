...
Apache JMeter is a suitable tool for this project because it can generate HTTP requests, parameterise thread counts, apply assertions, and produce response-time, throughput, and error-rate data (Apache Software Foundation 2026). In Rufeng Mall, JMeter plans are created for eight scenarios:
...
```mermaid
flowchart TD
    A[Open Rufeng Mall] --> B{Registered user?}
